...
infusoria = [   15,         #m  0 Скорость
                ...
                0]          #   11 Мутация
                #           #   12 Общее количство ходов
                #           #   13 Количество съеденной еды
                #           #   14 Результативность поедания (статический, задается при рождении и записывается детям)
                #           #   15 Родительская результативность
